...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO ITEMS (NAME, COST, STATUS, QTY, ID) VALUES ($1, $2, $3, $4, $5)";
    $params = array($name, $cost, $status, $qty, $id);
...
<head>
    ...
    <style>
        ...
        .form-group .status-options {
            display: flex;
            justify-content: space-around;
            align-items: center;
            width: 100%;
        }
        .form-group .status-options input[type="radio"] {
            margin-left: 10px;
        }
        .form-group .status-options label {
            margin-right: 10px;
        }
        .form-group button {
            width: 100%;
